  ...
  <div class="priority-container">
    ...
    <div class="table-container">
      <table>
        ...
        <tbody>
          <tr v-for="item in paginatedItems" :key="item.id" :class="{ 'highlight-mandatory': item.mandatory === 'Y' }">
...
import Pagination from "../../components/widgets/Pagination.vue"; // ✅ 페이지네이션 컴포넌트 임포트
